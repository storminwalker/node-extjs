...
(function() {
    ...
    bootstrap = this.ExtBootstrap = {
        ...
        requireAll: function() {
            document.write('<script type="text/javascript">Ext.require(\'*\')</script>');
        },
        
        onReady: function() {
             document.write('<script type="text/javascript">Ext.onReady(function() {' +
                            'ExtBootstrap.loadSpecs(function(){' +

Ext.data.JsonP.Ext_window_Window({
  ...
  "members": {
    "cfg": [
      ...
      },
      {
        ...
        "name": "closeAction",
        "owner": "Ext.panel.Panel",
        "doc": "<p>The action to take when the close header tool is clicked:\n<div class=\"mdetail-params\"><ul>\n<li><b><code>'<a href=\"#/api/Ext.window.Window-event-destroy\" rel=\"Ext.window.Window-event-destroy\" class=\"docClass\">destroy</a>'</code></b> : <b>Default</b><div class=\"sub-desc\">\n<a href=\"#/api/Ext.window.Window-event-destroy\" rel=\"Ext.window.Window-event-destroy\" class=\"docClass\">remove</a> the window from the DOM and <a href=\"#/api/Ext.Component-event-destroy\" rel=\"Ext.Component-event-destroy\" class=\"docClass\">destroy</a>\nit and all descendant Components. The window will <b>not</b> be available to be\nredisplayed via the <a href=\"#/api/Ext.window.Window-event-show\" rel=\"Ext.window.Window-event-show\" class=\"docClass\">show</a> method.\n</div></li>\n<li><b><code>'<a href=\"#/api/Ext.window.Window-event-hide\" rel=\"Ext.window.Window-event-hide\" class=\"docClass\">hide</a>'</code></b> : <div class=\"sub-desc\">\n<a href=\"#/api/Ext.window.Window-event-hide\" rel=\"Ext.window.Window-event-hide\" class=\"docClass\">hide</a> the window by setting visibility to hidden and applying negative offsets.\nThe window will be available to be redisplayed via the <a href=\"#/api/Ext.window.Window-event-show\" rel=\"Ext.window.Window-event-show\" class=\"docClass\">show</a> method.\n</div></li>\n</ul></div>\n<p><b>Note:</b> This behavior has changed! setting *does* affect the <a href=\"#/api/Ext.window.Window-method-close\" rel=\"Ext.window.Window-method-close\" class=\"docClass\">close</a> method\nwhich will invoke the approriate closeAction.\n\n",
        "linenr": 221,
        "html_filename": "Panel2.html"
      },
      {
      ...
      },
      {
        ...
        "owner": "Ext.panel.Panel",
        "doc": "<p>The direction to collapse the Panel when the toggle button is clicked.</p>\n\n\n<p>Defaults to the <a href=\"#/api/Ext.window.Window-cfg-headerPosition\" rel=\"Ext.window.Window-cfg-headerPosition\" class=\"docClass\">headerPosition</a></p>\n\n\n<p><b>Important: This config is <u>ignored</u> for <a href=\"#/api/Ext.window.Window-cfg-collapsible\" rel=\"Ext.window.Window-cfg-collapsible\" class=\"docClass\">collapsible</a> Panels which are direct child items of a <a href=\"#/api/Ext.layout.container.Border\" rel=\"Ext.layout.container.Border\" class=\"docClass\">border layout</a>.</b></p>\n\n\n<p>Specify as <code>'top'</code>, <code>'bottom'</code>, <code>'left'</code> or <code>'right'</code>.</p>\n\n",
        "linenr": 201,
        "html_filename": "Panel2.html"
      },
      {
      ...
      },
      {
        ...
        "name": "collapsed",
        "owner": "Ext.window.Window",
        "doc": "<p>True to render the window collapsed, false to render it expanded (defaults to false). Note that if\n<a href=\"#/api/Ext.window.Window-cfg-expandOnShow\" rel=\"Ext.window.Window-cfg-expandOnShow\" class=\"docClass\">expandOnShow</a> is true (the default) it will override the <code>collapsed</code> config and the window\nwill always be expanded when shown.</p>\n",
        "linenr": 74,
        "html_filename": "Window.html"
      },
      {
      ...
      },
      {
        ...
        "name": "constrain",
        "owner": "Ext.window.Window",
        "doc": "<p>True to constrain the window within its containing element, false to allow it to fall outside of its\ncontaining element. By default the window will be rendered to document.body.  To render and constrain the\nwindow within another element specify <a href=\"#/api/Ext.window.Window-cfg-renderTo\" rel=\"Ext.window.Window-cfg-renderTo\" class=\"docClass\">renderTo</a>.\n(defaults to false).  Optionally the header only can be constrained using <a href=\"#/api/Ext.window.Window-cfg-constrainHeader\" rel=\"Ext.window.Window-cfg-constrainHeader\" class=\"docClass\">constrainHeader</a>.</p>\n",
        "linenr": 107,
        "html_filename": "Window.html"
      },
      {
      ...
      },
      {
        ...
        "name": "expandOnShow",
        "owner": "Ext.window.Window",
        "doc": "<p>True to always expand the window when it is displayed, false to keep it in its current state (which may be\n<a href=\"#/api/Ext.window.Window-cfg-collapsed\" rel=\"Ext.window.Window-cfg-collapsed\" class=\"docClass\">collapsed</a>) when displayed (defaults to true).</p>\n",
        "linenr": 156,
        "html_filename": "Window.html"
      },
      {
      ...
      },
      {
        ...
        "name": "floatable",
        "owner": "Ext.panel.Panel",
        "doc": "<p><b>Important: This config is only effective for <a href=\"#/api/Ext.window.Window-cfg-collapsible\" rel=\"Ext.window.Window-cfg-collapsible\" class=\"docClass\">collapsible</a> Panels which are direct child items of a <a href=\"#/api/Ext.layout.container.Border\" rel=\"Ext.layout.container.Border\" class=\"docClass\">border layout</a>.</b></p>\n\n\n<p><tt>true</tt> to allow clicking a collapsed Panel&#39;s <a href=\"#/api/Ext.window.Window-cfg-placeholder\" rel=\"Ext.window.Window-cfg-placeholder\" class=\"docClass\">placeholder</a> to display the Panel floated\nabove the layout, <tt>false</tt> to force the user to fully expand a collapsed region by\nclicking the expand button to see it again (defaults to <tt>true</tt>).</p>\n",
        "linenr": 178,
        "html_filename": "Panel2.html"
      },
      {
      ...
      },
      {
        ...
        "doc": "<p>Specifies whether the floated component should be automatically <a href=\"#/api/Ext.window.Window-method-focus\" rel=\"Ext.window.Window-method-focus\" class=\"docClass\">focused</a> when it is\n<a href=\"#/api/Ext.window.Window-method-toFront\" rel=\"Ext.window.Window-method-toFront\" class=\"docClass\">brought to the front</a>. Defaults to true.</p>\n",
        "linenr": 9,
      ...
      },
      {
        ...
        "name": "hidden",
        "owner": "Ext.window.Window",
        "doc": "<p>Render this Window hidden (default is <code>true</code>). If <code>true</code>, the\n<a href=\"#/api/Ext.window.Window-event-hide\" rel=\"Ext.window.Window-event-hide\" class=\"docClass\">hide</a> method will be called internally.</p>\n",
        "linenr": 179,
        "html_filename": "Window.html"
      },
      {
        ...
        "owner": "Ext.panel.Panel",
        "doc": "<p><code>true</code> to hide the expand/collapse toggle button when <code><a href=\"#/api/Ext.window.Window-cfg-collapsible\" rel=\"Ext.window.Window-cfg-collapsible\" class=\"docClass\">collapsible</a> == true</code>,\n<code>false</code> to display it (defaults to <code>false</code>).</p>\n",
        "linenr": 141,
        "html_filename": "Panel2.html"
      },
      {
      ...
      },
      {
        ...
        "name": "placeholder",
        "owner": "Ext.panel.Panel",
        "doc": "<p><b>Important: This config is only effective for <a href=\"#/api/Ext.window.Window-cfg-collapsible\" rel=\"Ext.window.Window-cfg-collapsible\" class=\"docClass\">collapsible</a> Panels which are direct child items of a <a href=\"#/api/Ext.layout.container.Border\" rel=\"Ext.layout.container.Border\" class=\"docClass\">border layout</a>\nwhen not using the <code>'header'</code> <a href=\"#/api/Ext.window.Window-cfg-collapseMode\" rel=\"Ext.window.Window-cfg-collapseMode\" class=\"docClass\">collapseMode</a>.</b></p>\n\n\n<p><b>Optional.</b> A Component (or config object for a Component) to show in place of this Panel when this Panel is collapsed by a\n<a href=\"#/api/Ext.layout.container.Border\" rel=\"Ext.layout.container.Border\" class=\"docClass\">border layout</a>. Defaults to a generated <a href=\"#/api/Ext.panel.Header\" rel=\"Ext.panel.Header\" class=\"docClass\">Header</a>\ncontaining a <a href=\"#/api/Ext.panel.Tool\" rel=\"Ext.panel.Tool\" class=\"docClass\">Tool</a> to re-expand the Panel.</p>\n\n",
        "linenr": 169,
        "html_filename": "Panel2.html"
      },
      {
      ...
      },
      {
        ...
        "name": "titleCollapse",
        "owner": "Ext.panel.Panel",
        "doc": "<p><code>true</code> to allow expanding and collapsing the panel (when <code><a href=\"#/api/Ext.window.Window-cfg-collapsible\" rel=\"Ext.window.Window-cfg-collapsible\" class=\"docClass\">collapsible</a> = true</code>)\nby clicking anywhere in the header bar, <code>false</code>) to allow it only by clicking to tool button\n(defaults to <code>false</code>)).</p>\n",
        "linenr": 148,
        "html_filename": "Panel2.html"
      },
      {
        ...
        "name": "toFrontOnShow",
        "owner": "Ext.Component",
        "doc": "<p>True to automatically call <a href=\"#/api/Ext.window.Window-method-toFront\" rel=\"Ext.window.Window-method-toFront\" class=\"docClass\">toFront</a> when the <a href=\"#/api/Ext.window.Window-event-show\" rel=\"Ext.window.Window-event-show\" class=\"docClass\">show</a> method is called\non an already visible, floating component (default is <code>true</code>).</p>\n\n",
        "linenr": 202,
        "html_filename": "Component2.html"
      },
      {
        ...
        "name": "tools",
        "owner": "Ext.panel.Panel",
        "doc": "<p>An array of <a href=\"#/api/Ext.panel.Tool\" rel=\"Ext.panel.Tool\" class=\"docClass\">Ext.panel.Tool</a> configs/instances to be added to the header tool area. The tools are stored as child\ncomponents of the header container. They can be accessed using <a href=\"#/api/Ext.window.Window-method-down\" rel=\"Ext.window.Window-method-down\" class=\"docClass\">down</a> and {#query}, as well as the other\ncomponent methods. The toggle tool is automatically created if <a href=\"#/api/Ext.window.Window-cfg-collapsible\" rel=\"Ext.window.Window-cfg-collapsible\" class=\"docClass\">collapsible</a> is set to true.</p>\n\n<p>Note that, apart from the toggle tool which is provided when a panel is collapsible, these\ntools only provide the visual button. Any required functionality must be provided by adding\nhandlers that implement the necessary behavior.</p>\n\n\n<p>Example usage:</p>\n\n\n<pre><code>tools:[{\n    type:'refresh',\n    qtip: 'Refresh form Data',\n    // hidden:true,\n    handler: function(event, toolEl, panel){\n        // refresh logic\n    }\n},\n{\n    type:'help',\n    qtip: 'Get Help',\n    handler: function(event, toolEl, panel){\n        // show help here\n    }\n}]\n</code></pre>\n\n",
        "linenr": 279,
        "html_filename": "Panel2.html"
      },
      {
    ...
    "method": [
      ...
      },
      {
        ...
        "name": "close",
        "owner": "Ext.panel.Panel",
        "doc": "<p>Closes the Panel. By default, this method, removes it from the DOM, <a href=\"#/api/Ext.Component-event-destroy\" rel=\"Ext.Component-event-destroy\" class=\"docClass\">destroy</a>s\nthe Panel object and all its descendant Components. The beforeclose\nevent is fired before the close happens and will cancel the close action if it returns false.<p>\n<p><b>Note:</b> This method is not affected by the <a href=\"#/api/Ext.window.Window-cfg-closeAction\" rel=\"Ext.window.Window-cfg-closeAction\" class=\"docClass\">closeAction</a> setting which\nonly affects the action triggered when clicking the <a href=\"#/api/Ext.window.Window-cfg-closable\" rel=\"Ext.window.Window-cfg-closable\" class=\"docClass\">'close' tool in the header</a>.\nTo hide the Panel without destroying it, call <a href=\"#/api/Ext.window.Window-event-hide\" rel=\"Ext.window.Window-event-hide\" class=\"docClass\">hide</a>.</p>\n\n",
        "linenr": 755,
        "html_filename": "Panel2.html"
      },
      {
        ...
        "name": "collapse",
        "owner": "Ext.panel.Panel",
        "doc": "<p>Collapses the panel body so that the body becomes hidden. Docked Components parallel to the\nborder towards which the collapse takes place will remain visible.  Fires the <a href=\"#/api/Ext.window.Window-event-beforecollapse\" rel=\"Ext.window.Window-event-beforecollapse\" class=\"docClass\">beforecollapse</a> event which will\ncancel the collapse action if it returns false.</p>\n",
        "linenr": 891,
        "html_filename": "Panel2.html"
      },
      {
      ...
      },
      {
        ...
        "name": "expand",
        "owner": "Ext.panel.Panel",
        "doc": "<p>Expands the panel body so that it becomes visible.  Fires the <a href=\"#/api/Ext.window.Window-event-beforeexpand\" rel=\"Ext.window.Window-event-beforeexpand\" class=\"docClass\">beforeexpand</a> event which will\ncancel the expand action if it returns false.</p>\n",
        "linenr": 1182,
        "html_filename": "Panel2.html"
      },
      {
      ...
      },
      {
        ...
        "name": "insert",
        "owner": "Ext.container.AbstractContainer",
        "doc": "<p>Inserts a Component into this Container at a specified index. Fires the\n<a href=\"#/api/Ext.window.Window-event-beforeadd\" rel=\"Ext.window.Window-event-beforeadd\" class=\"docClass\">beforeadd</a> event before inserting, then fires the <a href=\"#/api/Ext.window.Window-event-add\" rel=\"Ext.window.Window-event-add\" class=\"docClass\">add</a> event after the\nComponent has been inserted.</p>\n",
        "linenr": 570,
        "html_filename": "AbstractContainer2.html"
      },
      {
      ...
      },
      {
        ...
        "name": "maximize",
        "owner": "Ext.window.Window",
        "doc": "<p>Fits the window within its current container and automatically replaces\nthe <a href=\"#/api/Ext.window.Window-cfg-maximizable\" rel=\"Ext.window.Window-cfg-maximizable\" class=\"docClass\">'maximize' tool button</a> with the 'restore' tool button.\nAlso see <a href=\"#/api/Ext.window.Window-method-toggleMaximize\" rel=\"Ext.window.Window-method-toggleMaximize\" class=\"docClass\">toggleMaximize</a>.</p>\n",
        "linenr": 605,
        "html_filename": "Window.html"
      },
      {
        ...
        "name": "minimize",
        "owner": "Ext.window.Window",
        "doc": "<p>Placeholder method for minimizing the window.  By default, this method simply fires the <a href=\"#/api/Ext.window.Window-event-minimize\" rel=\"Ext.window.Window-event-minimize\" class=\"docClass\">minimize</a> event\nsince the behavior of minimizing a window is application-specific.  To implement custom minimize behavior,\neither the minimize event can be handled or this method can be overridden.</p>\n",
        "linenr": 567,
        "html_filename": "Window.html"
      },
      {
      ...
      },
      {
        ...
        "name": "restore",
        "owner": "Ext.window.Window",
        "doc": "<p>Restores a <a href=\"#/api/Ext.window.Window-cfg-maximizable\" rel=\"Ext.window.Window-cfg-maximizable\" class=\"docClass\">maximized</a>  window back to its original\nsize and position prior to being maximized and also replaces\nthe 'restore' tool button with the 'maximize' tool button.\nAlso see <a href=\"#/api/Ext.window.Window-method-toggleMaximize\" rel=\"Ext.window.Window-method-toggleMaximize\" class=\"docClass\">toggleMaximize</a>.</p>\n",
        "linenr": 644,
        "html_filename": "Window.html"
      },
      {
        ...
        "params": [
          {
            "type": "Number",
            "optional": false,
            "doc": "<p>The new height to set. This may be one of:<div class=\"mdetail-params\"><ul>\n<li>A Number specifying the new height in the <a href=\"#/api/Ext.window.Window-method-getEl\" rel=\"Ext.window.Window-method-getEl\" class=\"docClass\">Element</a>'s <a href=\"#/api/Ext.core.Element-property-defaultUnit\" rel=\"Ext.core.Element-property-defaultUnit\" class=\"docClass\">Ext.core.Element.defaultUnit</a>s (by default, pixels).</li>\n<li>A String used to set the CSS height style.</li>\n<li><i>undefined</i> to leave the height unchanged.</li>\n</ul></div></p>\n",
            "name": "height"
          }
        ],
        ...
        "params": [
          {
            "type": "Mixed",
            "optional": false,
            "doc": "<p>The new width to set. This may be one of:<div class=\"mdetail-params\"><ul>\n<li>A Number specifying the new width in the <a href=\"#/api/Ext.window.Window-method-getEl\" rel=\"Ext.window.Window-method-getEl\" class=\"docClass\">Element</a>'s <a href=\"#/api/Ext.core.Element-property-defaultUnit\" rel=\"Ext.core.Element-property-defaultUnit\" class=\"docClass\">Ext.core.Element.defaultUnit</a>s (by default, pixels).</li>\n<li>A String used to set the CSS width style.</li>\n<li>A size object in the format <code>{width: widthValue, height: heightValue}</code>.</li>\n<li><code>undefined</code> to leave the width unchanged.</li>\n</ul></div></p>\n",
            "name": "width"
          },
          {
            "type": "Mixed",
      ...
      },
      {
        ...
        "name": "toggleCollapse",
        "owner": "Ext.panel.Panel",
        "doc": "<p>Shortcut for performing an <a href=\"#/api/Ext.window.Window-event-expand\" rel=\"Ext.window.Window-event-expand\" class=\"docClass\">expand</a> or <a href=\"#/api/Ext.window.Window-event-collapse\" rel=\"Ext.window.Window-event-collapse\" class=\"docClass\">collapse</a> based on the current state of the panel.</p>\n",
        "linenr": 1370,
        "html_filename": "Panel2.html"
      },
      {
        ...
        "name": "toggleMaximize",
        "owner": "Ext.window.Window",
        "doc": "<p>A shortcut method for toggling between <a href=\"#/api/Ext.window.Window-event-maximize\" rel=\"Ext.window.Window-event-maximize\" class=\"docClass\">maximize</a> and <a href=\"#/api/Ext.window.Window-event-restore\" rel=\"Ext.window.Window-event-restore\" class=\"docClass\">restore</a> based on the current maximized\nstate of the window.</p>\n",
        "linenr": 723,
        "html_filename": "Window.html"
      },
      {
    ...
    "event": [
      ...
      },
      {
        ...
        "name": "beforedestroy",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires before the component is <a href=\"#/api/Ext.window.Window-event-destroy\" rel=\"Ext.window.Window-event-destroy\" class=\"docClass\">destroy</a>ed. Return false from an event handler to stop the <a href=\"#/api/Ext.window.Window-event-destroy\" rel=\"Ext.window.Window-event-destroy\" class=\"docClass\">destroy</a>.</p>\n",
        "linenr": 668,
        "html_filename": "AbstractComponent.html"
      },
      {
      ...
      },
      {
        ...
        "name": "beforehide",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires before the component is hidden when calling the <a href=\"#/api/Ext.window.Window-event-hide\" rel=\"Ext.window.Window-event-hide\" class=\"docClass\">hide</a> method.\nReturn false from an event handler to stop the hide.</p>\n",
        "linenr": 626,
        "html_filename": "AbstractComponent.html"
      },
      {
      ...
      },
      {
        ...
        "name": "beforeshow",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires before the component is shown when calling the <a href=\"#/api/Ext.window.Window-event-show\" rel=\"Ext.window.Window-event-show\" class=\"docClass\">show</a> method.\nReturn false from an event handler to stop the show.</p>\n",
        "linenr": 613,
        "html_filename": "AbstractComponent.html"
      },
      {
      ...
      },
      {
        ...
        "name": "destroy",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires after the component is <a href=\"#/api/Ext.window.Window-event-destroy\" rel=\"Ext.window.Window-event-destroy\" class=\"docClass\">destroy</a>ed.</p>\n",
        "linenr": 674,
        "html_filename": "AbstractComponent.html"
      },
      {
      ...
      },
      {
        ...
        "name": "hide",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires after the component is hidden.\nFires after the component is hidden when calling the <a href=\"#/api/Ext.window.Window-event-hide\" rel=\"Ext.window.Window-event-hide\" class=\"docClass\">hide</a> method.</p>\n",
        "linenr": 633,
        "html_filename": "AbstractComponent.html"
      },
      {
      ...
      },
      {
        ...
        "name": "show",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires after the component is shown when calling the <a href=\"#/api/Ext.window.Window-event-show\" rel=\"Ext.window.Window-event-show\" class=\"docClass\">show</a> method.</p>\n",
        "linenr": 620,
        "html_filename": "AbstractComponent.html"
      },
      {
  ...
  "doc": "<p>A specialized panel intended for use as an application window.  Windows are floated, <a href=\"#/api/Ext.window.Window-cfg-resizable\" rel=\"Ext.window.Window-cfg-resizable\" class=\"docClass\">resizable</a>, and\n<a href=\"#/api/Ext.window.Window-property-draggable\" rel=\"Ext.window.Window-property-draggable\" class=\"docClass\">draggable</a> by default.  Windows can be <a href=\"#/api/Ext.window.Window-cfg-maximizable\" rel=\"Ext.window.Window-cfg-maximizable\" class=\"docClass\">maximized</a> to fill the viewport,\nrestored to their prior size, and can be <a href=\"#/api/Ext.window.Window-event-minimize\" rel=\"Ext.window.Window-event-minimize\" class=\"docClass\">minimize</a>d.</p>\n\n\n<p>Windows can also be linked to a <a href=\"#/api/Ext.ZIndexManager\" rel=\"Ext.ZIndexManager\" class=\"docClass\">Ext.ZIndexManager</a> or managed by the <a href=\"#/api/Ext.WindowManager\" rel=\"Ext.WindowManager\" class=\"docClass\">Ext.WindowManager</a> to provide\ngrouping, activation, to front, to back and other application-specific behavior.</p>\n\n\n<p>By default, Windows will be rendered to document.body. To <a href=\"#/api/Ext.window.Window-cfg-constrain\" rel=\"Ext.window.Window-cfg-constrain\" class=\"docClass\">constrain</a> a Window to another element\nspecify <a href=\"#/api/Ext.Component-cfg-renderTo\" rel=\"Ext.Component-cfg-renderTo\" class=\"docClass\">renderTo</a>.</p>\n\n\n<p><b>As with all <a href=\"#/api/Ext.container.Container\" rel=\"Ext.container.Container\" class=\"docClass\">Container</a>s, it is important to consider how you want the Window\nto size and arrange any child Components. Choose an appropriate <a href=\"#/api/Ext.window.Window-cfg-layout\" rel=\"Ext.window.Window-cfg-layout\" class=\"docClass\">layout</a> configuration which lays out\nchild Components in the required manner.</b></p>\n\n\n<p><p><img src=\"doc-resources/Ext.window.Window/Ext.window.Window.png\" alt=\"Window component\"></p>\nExample:<code></p>\n\n<pre>Ext.create('Ext.window.Window', {\n    title: 'Hello',\n    height: 200,\n    width: 400,\n    layout: 'fit',\n    items: {  // Let's put an empty grid in just to illustrate fit layout\n        xtype: 'grid',\n        border: false,\n        columns: [{header: 'World'}],                 // One header just for show. There's no data,\n        store: Ext.create('Ext.data.ArrayStore', {}) // A dummy empty data store\n    }\n}).show();\n</pre>\n\n\n<p></code></p>\n",
  "docauthor": null,
  "component": true,
  "linenr": 1,
  "xtypes": [

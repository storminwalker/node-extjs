Ext.data.JsonP.Ext_button_Split({
  ...
  "members": {
    "cfg": [
      {
        ...
        "doc": "<p>False to not allow a pressed Button to be depressed (defaults to undefined). Only valid when <a href=\"#/api/Ext.button.Split-cfg-enableToggle\" rel=\"Ext.button.Split-cfg-enableToggle\" class=\"docClass\">enableToggle</a> is true.</p>\n",
        "linenr": 220,
      ...
      },
      {
        ...
        "name": "arrowAlign",
        "owner": "Ext.button.Button",
        "doc": "<p>(Optional) The side of the Button box to render the arrow if the button has an associated <a href=\"#/api/Ext.button.Split-property-menu\" rel=\"Ext.button.Split-property-menu\" class=\"docClass\">menu</a>.\nTwo values are allowed:</p>\n\n\n<ul class=\"mdetail-params\">\n<li>'right'<div class=\"sub-desc\"></div></li>\n<li>'bottom'<div class=\"sub-desc\"></div></li>\n</ul>\n\n\n<p>Defaults to <b><tt>'right'</tt></b>.</p>\n\n",
        "linenr": 395,
        "html_filename": "Button.html"
      },
      {
      ...
      },
      {
        ...
        "tagname": "cfg",
        "alias": null,
        "filename": "/mnt/ebs/nightly/git/SDK/extjs/src/button/Split.js",
        "private": false,
        "static": false,
        "name": "arrowHandler",
      ...
      },
      {
        ...
        "doc": "<p>Specifies whether the floated component should be automatically <a href=\"#/api/Ext.button.Split-method-focus\" rel=\"Ext.button.Split-method-focus\" class=\"docClass\">focused</a> when it is\n<a href=\"#/api/Ext.button.Split-method-toFront\" rel=\"Ext.button.Split-method-toFront\" class=\"docClass\">brought to the front</a>. Defaults to true.</p>\n",
        "linenr": 9,
      ...
      },
      {
        ...
        "name": "params",
        "owner": "Ext.button.Button",
        "doc": "<p>An object literal of parameters to pass to the url when the href property is specified.\nAny params override <a href=\"#/api/Ext.button.Split-cfg-baseParams\" rel=\"Ext.button.Split-cfg-baseParams\" class=\"docClass\">baseParams</a>. New params can be set using the <a href=\"#/api/Ext.button.Split-method-setParams\" rel=\"Ext.button.Split-method-setParams\" class=\"docClass\">setParams</a> method.</p>\n",
        "linenr": 327,
        "html_filename": "Button.html"
      },
      {
      ...
      },
      {
        ...
        "name": "scope",
        "owner": "Ext.button.Button",
        "doc": "<p>The scope (<tt><b>this</b></tt> reference) in which the\n<code><a href=\"#/api/Ext.button.Split-cfg-handler\" rel=\"Ext.button.Split-cfg-handler\" class=\"docClass\">handler</a></code> and <code><a href=\"#/api/Ext.button.Split-cfg-toggleHandler\" rel=\"Ext.button.Split-cfg-toggleHandler\" class=\"docClass\">toggleHandler</a></code> is\nexecuted. Defaults to this Button.</p>\n",
        "linenr": 376,
        "html_filename": "Button.html"
      },
      {
      ...
      },
      {
        ...
        "name": "toFrontOnShow",
        "owner": "Ext.Component",
        "doc": "<p>True to automatically call <a href=\"#/api/Ext.button.Split-method-toFront\" rel=\"Ext.button.Split-method-toFront\" class=\"docClass\">toFront</a> when the <a href=\"#/api/Ext.button.Split-event-show\" rel=\"Ext.button.Split-event-show\" class=\"docClass\">show</a> method is called\non an already visible, floating component (default is <code>true</code>).</p>\n\n",
        "linenr": 202,
        "html_filename": "Component2.html"
      },
      {
      ...
      },
      {
        ...
        "name": "toggleHandler",
        "owner": "Ext.button.Button",
        "doc": "<p>Function called when a Button with <a href=\"#/api/Ext.button.Split-cfg-enableToggle\" rel=\"Ext.button.Split-cfg-enableToggle\" class=\"docClass\">enableToggle</a> set to true is clicked. Two arguments are passed:<ul class=\"mdetail-params\">\n<li><b>button</b> : Ext.button.Button<div class=\"sub-desc\">this Button object</div></li>\n<li><b>state</b> : Boolean<div class=\"sub-desc\">The next state of the Button, true means pressed.</div></li>\n</ul></p>\n",
        "linenr": 231,
        "html_filename": "Button.html"
      },
      {
    ...
    "method": [
        ...
        "params": [
          {
            "type": "Number",
            "optional": false,
            "doc": "<p>The new height to set. This may be one of:<div class=\"mdetail-params\"><ul>\n<li>A Number specifying the new height in the <a href=\"#/api/Ext.button.Split-method-getEl\" rel=\"Ext.button.Split-method-getEl\" class=\"docClass\">Element</a>'s <a href=\"#/api/Ext.core.Element-property-defaultUnit\" rel=\"Ext.core.Element-property-defaultUnit\" class=\"docClass\">Ext.core.Element.defaultUnit</a>s (by default, pixels).</li>\n<li>A String used to set the CSS height style.</li>\n<li><i>undefined</i> to leave the height unchanged.</li>\n</ul></div></p>\n",
            "name": "height"
          }
        ],
      ...
      },
      {
        ...
        "name": "setIcon",
        "owner": "Ext.button.Button",
        "doc": "<p>Sets the background image (inline style) of the button.  This method also changes\nthe value of the <a href=\"#/api/Ext.button.Split-cfg-icon\" rel=\"Ext.button.Split-cfg-icon\" class=\"docClass\">icon</a> config internally.</p>\n",
        "linenr": 887,
        "html_filename": "Button.html"
      },
      {
        ...
        "name": "setIconCls",
        "owner": "Ext.button.Button",
        "doc": "<p>Sets the CSS class that provides a background image to use as the button's icon.  This method also changes\nthe value of the <a href=\"#/api/Ext.button.Split-cfg-iconCls\" rel=\"Ext.button.Split-cfg-iconCls\" class=\"docClass\">iconCls</a> config internally.</p>\n",
        "linenr": 761,
        "html_filename": "Button.html"
      },
      {
      ...
      },
      {
        ...
        "name": "setParams",
        "owner": "Ext.button.Button",
        "doc": "<p><b>Only valid if the Button was originally configured with a url</b></p>\n\n\n<p>Sets the href of the link dynamically according to the params passed, and any <a href=\"#/api/Ext.button.Split-cfg-baseParams\" rel=\"Ext.button.Split-cfg-baseParams\" class=\"docClass\">baseParams</a> configured.</p>\n\n",
        "linenr": 737,
        "html_filename": "Button.html"
      },
      {
        ...
        "params": [
          {
            "type": "Mixed",
            "optional": false,
            "doc": "<p>The new width to set. This may be one of:<div class=\"mdetail-params\"><ul>\n<li>A Number specifying the new width in the <a href=\"#/api/Ext.button.Split-method-getEl\" rel=\"Ext.button.Split-method-getEl\" class=\"docClass\">Element</a>'s <a href=\"#/api/Ext.core.Element-property-defaultUnit\" rel=\"Ext.core.Element-property-defaultUnit\" class=\"docClass\">Ext.core.Element.defaultUnit</a>s (by default, pixels).</li>\n<li>A String used to set the CSS width style.</li>\n<li>A size object in the format <code>{width: widthValue, height: heightValue}</code>.</li>\n<li><code>undefined</code> to leave the width unchanged.</li>\n</ul></div></p>\n",
            "name": "width"
          },
          {
            "type": "Mixed",
    ...
    "event": [
      ...
      },
      {
        ...
        "name": "beforedestroy",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires before the component is <a href=\"#/api/Ext.button.Split-event-destroy\" rel=\"Ext.button.Split-event-destroy\" class=\"docClass\">destroy</a>ed. Return false from an event handler to stop the <a href=\"#/api/Ext.button.Split-event-destroy\" rel=\"Ext.button.Split-event-destroy\" class=\"docClass\">destroy</a>.</p>\n",
        "linenr": 668,
        "html_filename": "AbstractComponent.html"
      },
      {
        ...
        "name": "beforehide",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires before the component is hidden when calling the <a href=\"#/api/Ext.button.Split-event-hide\" rel=\"Ext.button.Split-event-hide\" class=\"docClass\">hide</a> method.\nReturn false from an event handler to stop the hide.</p>\n",
        "linenr": 626,
        "html_filename": "AbstractComponent.html"
      },
      {
      ...
      },
      {
        ...
        "name": "beforeshow",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires before the component is shown when calling the <a href=\"#/api/Ext.button.Split-event-show\" rel=\"Ext.button.Split-event-show\" class=\"docClass\">show</a> method.\nReturn false from an event handler to stop the show.</p>\n",
        "linenr": 613,
        "html_filename": "AbstractComponent.html"
      },
      {
      ...
      },
      {
        ...
        "name": "destroy",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires after the component is <a href=\"#/api/Ext.button.Split-event-destroy\" rel=\"Ext.button.Split-event-destroy\" class=\"docClass\">destroy</a>ed.</p>\n",
        "linenr": 674,
        "html_filename": "AbstractComponent.html"
      },
      {
      ...
      },
      {
        ...
        "name": "hide",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires after the component is hidden.\nFires after the component is hidden when calling the <a href=\"#/api/Ext.button.Split-event-hide\" rel=\"Ext.button.Split-event-hide\" class=\"docClass\">hide</a> method.</p>\n",
        "linenr": 633,
        "html_filename": "AbstractComponent.html"
      },
      {
      ...
      },
      {
        ...
        "name": "show",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires after the component is shown when calling the <a href=\"#/api/Ext.button.Split-event-show\" rel=\"Ext.button.Split-event-show\" class=\"docClass\">show</a> method.</p>\n",
        "linenr": 620,
        "html_filename": "AbstractComponent.html"
      },
      {
    ...
    "property": [
      ...
      },
      {
        ...
        "name": "menu",
        "owner": "Ext.button.Button",
        "doc": "<p>The <a href=\"#/api/Ext.menu.Menu\" rel=\"Ext.menu.Menu\" class=\"docClass\">Menu</a> object associated with this Button when configured with the <a href=\"#/api/Ext.button.Split-property-menu\" rel=\"Ext.button.Split-property-menu\" class=\"docClass\">menu</a> config option.</p>\n",
        "linenr": 427,
        "html_filename": "Button.html"
      },
      {
  ...
  "doc": "<p>A split button that provides a built-in dropdown arrow that can fire an event separately from the default\nclick event of the button.  Typically this would be used to display a dropdown menu that provides additional\noptions to the primary button action, but any custom handler can provide the arrowclick implementation.<br/>\n<p><img src=\"doc-resources/Ext.button.Split/Ext.button.Split.png\" alt=\"Ext.button.Split component\"></p>\nExample usage:</p>\n\n<pre><code>// display a dropdown menu:\n    Ext.create('Ext.button.Split', {\n        renderTo: 'button-ct', // the container id\n        text: 'Options',\n        handler: optionsHandler, // handle a click on the button itself\n        menu: new Ext.menu.Menu({\n        items: [\n                // these items will render as dropdown menu items when the arrow is clicked:\n                {text: 'Item 1', handler: item1Handler},\n                {text: 'Item 2', handler: item2Handler}\n        ]\n        })\n    });\n\n// Instead of showing a menu, you provide any type of custom\n// functionality you want when the dropdown arrow is clicked:\n    Ext.create('Ext.button.Split', {\n        renderTo: 'button-ct',\n        text: 'Options',\n        handler: optionsHandler,\n        arrowHandler: myCustomHandler\n    });\n</code></pre>\n\n",
  "docauthor": null,
  "component": true,
  "linenr": 1,
  "xtypes": [

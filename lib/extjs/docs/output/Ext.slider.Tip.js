Ext.data.JsonP.Ext_slider_Tip({
  ...
  "members": {
    "cfg": [
      ...
      },
      {
        ...
        "name": "closeAction",
        "owner": "Ext.tip.Tip",
        "doc": "<p>The action to take when the close header tool is clicked:\n<div class=\"mdetail-params\"><ul>\n<li><b><code>'<a href=\"#/api/Ext.slider.Tip-event-destroy\" rel=\"Ext.slider.Tip-event-destroy\" class=\"docClass\">destroy</a>'</code></b> : <div class=\"sub-desc\">\n<a href=\"#/api/Ext.slider.Tip-event-destroy\" rel=\"Ext.slider.Tip-event-destroy\" class=\"docClass\">remove</a> the window from the DOM and <a href=\"#/api/Ext.Component-event-destroy\" rel=\"Ext.Component-event-destroy\" class=\"docClass\">destroy</a>\nit and all descendant Components. The window will <b>not</b> be available to be\nredisplayed via the <a href=\"#/api/Ext.slider.Tip-event-show\" rel=\"Ext.slider.Tip-event-show\" class=\"docClass\">show</a> method.\n</div></li>\n<li><b><code>'<a href=\"#/api/Ext.slider.Tip-event-hide\" rel=\"Ext.slider.Tip-event-hide\" class=\"docClass\">hide</a>'</code></b> : <b>Default</b><div class=\"sub-desc\">\n<a href=\"#/api/Ext.slider.Tip-event-hide\" rel=\"Ext.slider.Tip-event-hide\" class=\"docClass\">hide</a> the window by setting visibility to hidden and applying negative offsets.\nThe window will be available to be redisplayed via the <a href=\"#/api/Ext.slider.Tip-event-show\" rel=\"Ext.slider.Tip-event-show\" class=\"docClass\">show</a> method.\n</div></li>\n</ul></div>\n<p><b>Note:</b> This behavior has changed! setting *does* affect the <a href=\"#/api/Ext.slider.Tip-method-close\" rel=\"Ext.slider.Tip-method-close\" class=\"docClass\">close</a> method\nwhich will invoke the approriate closeAction.\n\n",
        "linenr": 63,
        "html_filename": "Tip3.html"
      },
      {
      ...
      },
      {
        ...
        "owner": "Ext.panel.Panel",
        "doc": "<p>The direction to collapse the Panel when the toggle button is clicked.</p>\n\n\n<p>Defaults to the <a href=\"#/api/Ext.slider.Tip-cfg-headerPosition\" rel=\"Ext.slider.Tip-cfg-headerPosition\" class=\"docClass\">headerPosition</a></p>\n\n\n<p><b>Important: This config is <u>ignored</u> for <a href=\"#/api/Ext.slider.Tip-cfg-collapsible\" rel=\"Ext.slider.Tip-cfg-collapsible\" class=\"docClass\">collapsible</a> Panels which are direct child items of a <a href=\"#/api/Ext.layout.container.Border\" rel=\"Ext.layout.container.Border\" class=\"docClass\">border layout</a>.</b></p>\n\n\n<p>Specify as <code>'top'</code>, <code>'bottom'</code>, <code>'left'</code> or <code>'right'</code>.</p>\n\n",
        "linenr": 201,
        "html_filename": "Panel2.html"
      },
      {
      ...
      },
      {
        ...
        "name": "floatable",
        "owner": "Ext.panel.Panel",
        "doc": "<p><b>Important: This config is only effective for <a href=\"#/api/Ext.slider.Tip-cfg-collapsible\" rel=\"Ext.slider.Tip-cfg-collapsible\" class=\"docClass\">collapsible</a> Panels which are direct child items of a <a href=\"#/api/Ext.layout.container.Border\" rel=\"Ext.layout.container.Border\" class=\"docClass\">border layout</a>.</b></p>\n\n\n<p><tt>true</tt> to allow clicking a collapsed Panel&#39;s <a href=\"#/api/Ext.slider.Tip-cfg-placeholder\" rel=\"Ext.slider.Tip-cfg-placeholder\" class=\"docClass\">placeholder</a> to display the Panel floated\nabove the layout, <tt>false</tt> to force the user to fully expand a collapsed region by\nclicking the expand button to see it again (defaults to <tt>true</tt>).</p>\n",
        "linenr": 178,
        "html_filename": "Panel2.html"
      },
      {
      ...
      },
      {
        ...
        "doc": "<p>Specifies whether the floated component should be automatically <a href=\"#/api/Ext.slider.Tip-method-focus\" rel=\"Ext.slider.Tip-method-focus\" class=\"docClass\">focused</a> when it is\n<a href=\"#/api/Ext.slider.Tip-method-toFront\" rel=\"Ext.slider.Tip-method-toFront\" class=\"docClass\">brought to the front</a>. Defaults to true.</p>\n",
        "linenr": 9,
      ...
      },
      {
        ...
        "owner": "Ext.panel.Panel",
        "doc": "<p><code>true</code> to hide the expand/collapse toggle button when <code><a href=\"#/api/Ext.slider.Tip-cfg-collapsible\" rel=\"Ext.slider.Tip-cfg-collapsible\" class=\"docClass\">collapsible</a> == true</code>,\n<code>false</code> to display it (defaults to <code>false</code>).</p>\n",
        "linenr": 141,
        "html_filename": "Panel2.html"
      },
      {
      ...
      },
      {
        ...
        "name": "placeholder",
        "owner": "Ext.panel.Panel",
        "doc": "<p><b>Important: This config is only effective for <a href=\"#/api/Ext.slider.Tip-cfg-collapsible\" rel=\"Ext.slider.Tip-cfg-collapsible\" class=\"docClass\">collapsible</a> Panels which are direct child items of a <a href=\"#/api/Ext.layout.container.Border\" rel=\"Ext.layout.container.Border\" class=\"docClass\">border layout</a>\nwhen not using the <code>'header'</code> <a href=\"#/api/Ext.slider.Tip-cfg-collapseMode\" rel=\"Ext.slider.Tip-cfg-collapseMode\" class=\"docClass\">collapseMode</a>.</b></p>\n\n\n<p><b>Optional.</b> A Component (or config object for a Component) to show in place of this Panel when this Panel is collapsed by a\n<a href=\"#/api/Ext.layout.container.Border\" rel=\"Ext.layout.container.Border\" class=\"docClass\">border layout</a>. Defaults to a generated <a href=\"#/api/Ext.panel.Header\" rel=\"Ext.panel.Header\" class=\"docClass\">Header</a>\ncontaining a <a href=\"#/api/Ext.panel.Tool\" rel=\"Ext.panel.Tool\" class=\"docClass\">Tool</a> to re-expand the Panel.</p>\n\n",
        "linenr": 169,
        "html_filename": "Panel2.html"
      },
      {
      ...
      },
      {
        ...
        "name": "titleCollapse",
        "owner": "Ext.panel.Panel",
        "doc": "<p><code>true</code> to allow expanding and collapsing the panel (when <code><a href=\"#/api/Ext.slider.Tip-cfg-collapsible\" rel=\"Ext.slider.Tip-cfg-collapsible\" class=\"docClass\">collapsible</a> = true</code>)\nby clicking anywhere in the header bar, <code>false</code>) to allow it only by clicking to tool button\n(defaults to <code>false</code>)).</p>\n",
        "linenr": 148,
        "html_filename": "Panel2.html"
      },
      {
        ...
        "name": "toFrontOnShow",
        "owner": "Ext.Component",
        "doc": "<p>True to automatically call <a href=\"#/api/Ext.slider.Tip-method-toFront\" rel=\"Ext.slider.Tip-method-toFront\" class=\"docClass\">toFront</a> when the <a href=\"#/api/Ext.slider.Tip-event-show\" rel=\"Ext.slider.Tip-event-show\" class=\"docClass\">show</a> method is called\non an already visible, floating component (default is <code>true</code>).</p>\n\n",
        "linenr": 202,
        "html_filename": "Component2.html"
      },
      {
        ...
        "name": "tools",
        "owner": "Ext.panel.Panel",
        "doc": "<p>An array of <a href=\"#/api/Ext.panel.Tool\" rel=\"Ext.panel.Tool\" class=\"docClass\">Ext.panel.Tool</a> configs/instances to be added to the header tool area. The tools are stored as child\ncomponents of the header container. They can be accessed using <a href=\"#/api/Ext.slider.Tip-method-down\" rel=\"Ext.slider.Tip-method-down\" class=\"docClass\">down</a> and {#query}, as well as the other\ncomponent methods. The toggle tool is automatically created if <a href=\"#/api/Ext.slider.Tip-cfg-collapsible\" rel=\"Ext.slider.Tip-cfg-collapsible\" class=\"docClass\">collapsible</a> is set to true.</p>\n\n<p>Note that, apart from the toggle tool which is provided when a panel is collapsible, these\ntools only provide the visual button. Any required functionality must be provided by adding\nhandlers that implement the necessary behavior.</p>\n\n\n<p>Example usage:</p>\n\n\n<pre><code>tools:[{\n    type:'refresh',\n    qtip: 'Refresh form Data',\n    // hidden:true,\n    handler: function(event, toolEl, panel){\n        // refresh logic\n    }\n},\n{\n    type:'help',\n    qtip: 'Get Help',\n    handler: function(event, toolEl, panel){\n        // show help here\n    }\n}]\n</code></pre>\n\n",
        "linenr": 279,
        "html_filename": "Panel2.html"
      },
      {
    ...
    "method": [
      ...
      },
      {
        ...
        "name": "close",
        "owner": "Ext.panel.Panel",
        "doc": "<p>Closes the Panel. By default, this method, removes it from the DOM, <a href=\"#/api/Ext.Component-event-destroy\" rel=\"Ext.Component-event-destroy\" class=\"docClass\">destroy</a>s\nthe Panel object and all its descendant Components. The beforeclose\nevent is fired before the close happens and will cancel the close action if it returns false.<p>\n<p><b>Note:</b> This method is not affected by the <a href=\"#/api/Ext.slider.Tip-cfg-closeAction\" rel=\"Ext.slider.Tip-cfg-closeAction\" class=\"docClass\">closeAction</a> setting which\nonly affects the action triggered when clicking the <a href=\"#/api/Ext.slider.Tip-cfg-closable\" rel=\"Ext.slider.Tip-cfg-closable\" class=\"docClass\">'close' tool in the header</a>.\nTo hide the Panel without destroying it, call <a href=\"#/api/Ext.slider.Tip-event-hide\" rel=\"Ext.slider.Tip-event-hide\" class=\"docClass\">hide</a>.</p>\n\n",
        "linenr": 755,
        "html_filename": "Panel2.html"
      },
      {
        ...
        "name": "collapse",
        "owner": "Ext.panel.Panel",
        "doc": "<p>Collapses the panel body so that the body becomes hidden. Docked Components parallel to the\nborder towards which the collapse takes place will remain visible.  Fires the <a href=\"#/api/Ext.slider.Tip-event-beforecollapse\" rel=\"Ext.slider.Tip-event-beforecollapse\" class=\"docClass\">beforecollapse</a> event which will\ncancel the collapse action if it returns false.</p>\n",
        "linenr": 891,
        "html_filename": "Panel2.html"
      },
      {
      ...
      },
      {
        ...
        "name": "expand",
        "owner": "Ext.panel.Panel",
        "doc": "<p>Expands the panel body so that it becomes visible.  Fires the <a href=\"#/api/Ext.slider.Tip-event-beforeexpand\" rel=\"Ext.slider.Tip-event-beforeexpand\" class=\"docClass\">beforeexpand</a> event which will\ncancel the expand action if it returns false.</p>\n",
        "linenr": 1182,
        "html_filename": "Panel2.html"
      },
      {
      ...
      },
      {
        ...
        "href": "Tip.html#Ext-slider-Tip-method-getText",
        "return": {
          "type": "String",
        ...
        "tagname": "method",
        "alias": null,
        "filename": "/mnt/ebs/nightly/git/SDK/extjs/src/slider/Tip.js",
        "private": false,
        "shortDoc": "Used to create the text that appears in the Tip's body. ...",
        "static": false,
        "name": "getText",
        "owner": "Ext.slider.Tip",
        "doc": "<p>Used to create the text that appears in the Tip's body. By default this just returns\nthe value of the Slider Thumb that the Tip is attached to. Override to customize.</p>\n",
        "linenr": 66,
        "html_filename": "Tip.html"
      },
      {
        "inheritable": false,
        "deprecated": null,
      ...
      },
      {
        ...
        "name": "insert",
        "owner": "Ext.container.AbstractContainer",
        "doc": "<p>Inserts a Component into this Container at a specified index. Fires the\n<a href=\"#/api/Ext.slider.Tip-event-beforeadd\" rel=\"Ext.slider.Tip-event-beforeadd\" class=\"docClass\">beforeadd</a> event before inserting, then fires the <a href=\"#/api/Ext.slider.Tip-event-add\" rel=\"Ext.slider.Tip-event-add\" class=\"docClass\">add</a> event after the\nComponent has been inserted.</p>\n",
        "linenr": 570,
        "html_filename": "AbstractContainer2.html"
      },
      {
      ...
      },
      {
        ...
        "params": [
          {
            "type": "Mixed",
            "optional": false,
            "doc": "<p>An HTMLElement, Ext.core.Element or string id of the target element to align to</p>\n",
            "name": "el"
          },
          {
            "type": "String",
            "optional": true,
            "doc": "<p>(optional) A valid <a href=\"#/api/Ext.core.Element-method-alignTo\" rel=\"Ext.core.Element-method-alignTo\" class=\"docClass\">Ext.core.Element.alignTo</a> anchor position (defaults to 'tl-br?' or\n<a href=\"#/api/Ext.slider.Tip-cfg-defaultAlign\" rel=\"Ext.slider.Tip-cfg-defaultAlign\" class=\"docClass\">defaultAlign</a> if specified).</p>\n",
            "name": "position"
          }
        ],
        ...
        "name": "showBy",
        "owner": "Ext.tip.Tip",
        "doc": "<p><b>Experimental</b>. Shows this tip at a position relative to another element using a standard <a href=\"#/api/Ext.core.Element-method-alignTo\" rel=\"Ext.core.Element-method-alignTo\" class=\"docClass\">Ext.core.Element.alignTo</a>\nanchor position value.  Example usage:</p>\n\n<pre><code>// Show the tip at the default position ('tl-br?')\ntip.showBy('my-el');\n\n// Show the tip's top-left corner anchored to the element's top-right corner\ntip.showBy('my-el', 'tl-tr');\n</code></pre>\n\n",
        "linenr": 112,
        "html_filename": "Tip3.html"
      },
      {
      ...
      },
      {
        ...
        "name": "toggleCollapse",
        "owner": "Ext.panel.Panel",
        "doc": "<p>Shortcut for performing an <a href=\"#/api/Ext.slider.Tip-event-expand\" rel=\"Ext.slider.Tip-event-expand\" class=\"docClass\">expand</a> or <a href=\"#/api/Ext.slider.Tip-event-collapse\" rel=\"Ext.slider.Tip-event-collapse\" class=\"docClass\">collapse</a> based on the current state of the panel.</p>\n",
        "linenr": 1370,
        "html_filename": "Panel2.html"
      },
      {
    ...
    "event": [
      ...
      },
      {
        ...
        "name": "beforedestroy",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires before the component is <a href=\"#/api/Ext.slider.Tip-event-destroy\" rel=\"Ext.slider.Tip-event-destroy\" class=\"docClass\">destroy</a>ed. Return false from an event handler to stop the <a href=\"#/api/Ext.slider.Tip-event-destroy\" rel=\"Ext.slider.Tip-event-destroy\" class=\"docClass\">destroy</a>.</p>\n",
        "linenr": 668,
        "html_filename": "AbstractComponent.html"
      },
      {
      ...
      },
      {
        ...
        "name": "beforehide",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires before the component is hidden when calling the <a href=\"#/api/Ext.slider.Tip-event-hide\" rel=\"Ext.slider.Tip-event-hide\" class=\"docClass\">hide</a> method.\nReturn false from an event handler to stop the hide.</p>\n",
        "linenr": 626,
        "html_filename": "AbstractComponent.html"
      },
      {
      ...
      },
      {
        ...
        "name": "beforeshow",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires before the component is shown when calling the <a href=\"#/api/Ext.slider.Tip-event-show\" rel=\"Ext.slider.Tip-event-show\" class=\"docClass\">show</a> method.\nReturn false from an event handler to stop the show.</p>\n",
        "linenr": 613,
        "html_filename": "AbstractComponent.html"
      },
      {
      ...
      },
      {
        ...
        "name": "destroy",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires after the component is <a href=\"#/api/Ext.slider.Tip-event-destroy\" rel=\"Ext.slider.Tip-event-destroy\" class=\"docClass\">destroy</a>ed.</p>\n",
        "linenr": 674,
        "html_filename": "AbstractComponent.html"
      },
      {
      ...
      },
      {
        ...
        "name": "hide",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires after the component is hidden.\nFires after the component is hidden when calling the <a href=\"#/api/Ext.slider.Tip-event-hide\" rel=\"Ext.slider.Tip-event-hide\" class=\"docClass\">hide</a> method.</p>\n",
        "linenr": 633,
        "html_filename": "AbstractComponent.html"
      },
      {
      ...
      },
      {
        ...
        "name": "show",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires after the component is shown when calling the <a href=\"#/api/Ext.slider.Tip-event-show\" rel=\"Ext.slider.Tip-event-show\" class=\"docClass\">show</a> method.</p>\n",
        "linenr": 620,
        "html_filename": "AbstractComponent.html"
      },
      {
    ...
    "property": [
      {
        ...
        "name": "dd",
        "owner": "Ext.panel.Panel",
        "doc": "<p>If this Panel is configured <a href=\"#/api/Ext.slider.Tip-property-draggable\" rel=\"Ext.slider.Tip-property-draggable\" class=\"docClass\">draggable</a>, this property will contain\nan instance of <a href=\"#/api/Ext.dd.DragSource\" rel=\"Ext.dd.DragSource\" class=\"docClass\">Ext.dd.DragSource</a> which handles dragging the Panel.</p>\n\n\n<p>The developer must provide implementations of the abstract methods of <a href=\"#/api/Ext.dd.DragSource\" rel=\"Ext.dd.DragSource\" class=\"docClass\">Ext.dd.DragSource</a>\nin order to supply behaviour for each stage of the drag/drop process. See <a href=\"#/api/Ext.slider.Tip-property-draggable\" rel=\"Ext.slider.Tip-property-draggable\" class=\"docClass\">draggable</a>.</p>\n",
        "linenr": 1393,
        "html_filename": "Panel2.html"
      },
      {
  ...
  "static": false,
  "name": "Ext.slider.Tip",
  "doc": "<p>Simple plugin for using an <a href=\"#/api/Ext.tip.Tip\" rel=\"Ext.tip.Tip\" class=\"docClass\">Ext.tip.Tip</a> with a slider to show the slider value. In general this\nclass is not created directly, instead pass the <a href=\"#/api/Ext.slider.Multi-cfg-useTips\" rel=\"Ext.slider.Multi-cfg-useTips\" class=\"docClass\">Ext.slider.Multi.useTips</a> and\n<a href=\"#/api/Ext.slider.Multi-cfg-tipText\" rel=\"Ext.slider.Multi-cfg-tipText\" class=\"docClass\">Ext.slider.Multi.tipText</a> configuration options to the slider directly.\n<p><img src=\"doc-resources/Ext.slider.Tip/Ext.slider.Tip1.png\" alt=\"Ext.slider.Tip component\"></p>\nExample usage:</p>\n\n<pre>    Ext.create('Ext.slider.Single', {\n        width: 214,\n        minValue: 0,\n        maxValue: 100,\n        useTips: true,\n        renderTo: Ext.getBody()\n    });   \n</pre>\n\n\n<p>Optionally provide your own tip text by passing tipText:</p>\n\n<pre> new Ext.slider.Single({\n     width: 214,\n     minValue: 0,\n     maxValue: 100,\n     useTips: true,\n     tipText: function(thumb){\n         return Ext.String.format('<b>{0}% complete</b>', thumb.value);\n     }\n });\n </pre>\n\n",
  "docauthor": null,
  "component": true,
  "linenr": 1,
  "xtypes": [

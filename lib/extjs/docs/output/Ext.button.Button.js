Ext.data.JsonP.Ext_button_Button({
  ...
  "members": {
    "cfg": [
      {
        ...
        "tagname": "cfg",
        "alias": null,
        "filename": "/mnt/ebs/nightly/git/SDK/extjs/src/button/Button.js",
        "private": false,
        "shortDoc": "False to not allow a pressed Button to be depressed (defaults to undefined). ...",
        "static": false,
        "name": "allowDepress",
        "owner": "Ext.button.Button",
        "doc": "<p>False to not allow a pressed Button to be depressed (defaults to undefined). Only valid when <a href=\"#/api/Ext.button.Button-cfg-enableToggle\" rel=\"Ext.button.Button-cfg-enableToggle\" class=\"docClass\">enableToggle</a> is true.</p>\n",
        "linenr": 220,
      ...
      },
      {
        ...
        "filename": "/mnt/ebs/nightly/git/SDK/extjs/src/button/Button.js",
        "private": false,
        "shortDoc": "(Optional) The side of the Button box to render the arrow if the button has an associated menu. ...",
        "static": false,
        "name": "arrowAlign",
        "owner": "Ext.button.Button",
        "doc": "<p>(Optional) The side of the Button box to render the arrow if the button has an associated <a href=\"#/api/Ext.button.Button-property-menu\" rel=\"Ext.button.Button-property-menu\" class=\"docClass\">menu</a>.\nTwo values are allowed:</p>\n\n\n<ul class=\"mdetail-params\">\n<li>'right'<div class=\"sub-desc\"></div></li>\n<li>'bottom'<div class=\"sub-desc\"></div></li>\n</ul>\n\n\n<p>Defaults to <b><tt>'right'</tt></b>.</p>\n\n",
        "linenr": 395,
        "html_filename": "Button.html"
      },
      {
        ...
        "name": "arrowCls",
        "owner": "Ext.button.Button",
        "doc": "<p>(Optional) The className used for the inner arrow element if the button has a menu.</p>\n\n",
        "linenr": 407,
        "html_filename": "Button.html"
      },
      {
      ...
      },
      {
        ...
        "doc": "<p>Specifies whether the floated component should be automatically <a href=\"#/api/Ext.button.Button-method-focus\" rel=\"Ext.button.Button-method-focus\" class=\"docClass\">focused</a> when it is\n<a href=\"#/api/Ext.button.Button-method-toFront\" rel=\"Ext.button.Button-method-toFront\" class=\"docClass\">brought to the front</a>. Defaults to true.</p>\n",
        "linenr": 9,
      ...
      },
      {
        ...
        "name": "handler",
        "owner": "Ext.button.Button",
        "doc": "<p>A function called when the button is clicked (can be used instead of click event).\nThe handler is passed the following parameters:<div class=\"mdetail-params\"><ul>\n<li><code>b</code> : Button<div class=\"sub-desc\">This Button.</div></li>\n<li><code>e</code> : EventObject<div class=\"sub-desc\">The click event.</div></li>\n</ul></div></p>\n",
        "linenr": 178,
        "html_filename": "Button.html"
      },
      {
      ...
      },
      {
        ...
        "filename": "/mnt/ebs/nightly/git/SDK/extjs/src/button/Button.js",
        "private": false,
        "shortDoc": "The path to an image to display in the button (the image will be set as the background-image\nCSS property of the butt...",
        "static": false,
        "name": "icon",
        "owner": "Ext.button.Button",
        "doc": "<p>The path to an image to display in the button (the image will be set as the background-image\nCSS property of the button by default, so if you want a mixed icon/text button, set cls:'x-btn-text-icon')</p>\n",
        "linenr": 173,
        "html_filename": "Button.html"
      },
      {
        ...
        "filename": "/mnt/ebs/nightly/git/SDK/extjs/src/button/Button.js",
        "private": false,
        "shortDoc": "(Optional) The side of the Button box to render the icon. ...",
        "static": false,
        "name": "iconAlign",
        "owner": "Ext.button.Button",
        "doc": "<p>(Optional) The side of the Button box to render the icon. Four values are allowed:</p>\n\n\n<ul class=\"mdetail-params\">\n<li>'top'<div class=\"sub-desc\"></div></li>\n<li>'right'<div class=\"sub-desc\"></div></li>\n<li>'bottom'<div class=\"sub-desc\"></div></li>\n<li>'left'<div class=\"sub-desc\"></div></li>\n</ul>\n\n\n<p>Defaults to <b><tt>'left'</tt></b>.</p>\n\n",
        "linenr": 382,
        "html_filename": "Button.html"
      },
      {
      ...
      },
      {
        ...
        "filename": "/mnt/ebs/nightly/git/SDK/extjs/src/button/Button.js",
        "private": false,
        "shortDoc": "Standard menu attribute consisting of a reference to a menu object, a menu id or a menu config blob (defaults to unde...",
        "static": false,
        "name": "menu",
        "owner": "Ext.button.Button",
        "doc": "<p>Standard menu attribute consisting of a reference to a menu object, a menu id or a menu config blob (defaults to undefined).</p>\n",
        "linenr": 239,
        "html_filename": "Button.html"
      },
      {
      ...
      },
      {
        ...
        "name": "menuAlign",
        "owner": "Ext.button.Button",
        "doc": "<p>The position to align the menu to (see <a href=\"#/api/Ext.core.Element-method-alignTo\" rel=\"Ext.core.Element-method-alignTo\" class=\"docClass\">Ext.core.Element.alignTo</a> for more details, defaults to 'tl-bl?').</p>\n",
        "linenr": 244,
        "html_filename": "Button.html"
      },
      {
      ...
      },
      {
        ...
        "name": "params",
        "owner": "Ext.button.Button",
        "doc": "<p>An object literal of parameters to pass to the url when the href property is specified.\nAny params override <a href=\"#/api/Ext.button.Button-cfg-baseParams\" rel=\"Ext.button.Button-cfg-baseParams\" class=\"docClass\">baseParams</a>. New params can be set using the <a href=\"#/api/Ext.button.Button-method-setParams\" rel=\"Ext.button.Button-method-setParams\" class=\"docClass\">setParams</a> method.</p>\n",
        "linenr": 327,
        "html_filename": "Button.html"
      },
      {
      ...
      },
      {
        ...
        "name": "scope",
        "owner": "Ext.button.Button",
        "doc": "<p>The scope (<tt><b>this</b></tt> reference) in which the\n<code><a href=\"#/api/Ext.button.Button-cfg-handler\" rel=\"Ext.button.Button-cfg-handler\" class=\"docClass\">handler</a></code> and <code><a href=\"#/api/Ext.button.Button-cfg-toggleHandler\" rel=\"Ext.button.Button-cfg-toggleHandler\" class=\"docClass\">toggleHandler</a></code> is\nexecuted. Defaults to this Button.</p>\n",
        "linenr": 376,
        "html_filename": "Button.html"
      },
      {
      ...
      },
      {
        ...
        "name": "toFrontOnShow",
        "owner": "Ext.Component",
        "doc": "<p>True to automatically call <a href=\"#/api/Ext.button.Button-method-toFront\" rel=\"Ext.button.Button-method-toFront\" class=\"docClass\">toFront</a> when the <a href=\"#/api/Ext.button.Button-event-show\" rel=\"Ext.button.Button-event-show\" class=\"docClass\">show</a> method is called\non an already visible, floating component (default is <code>true</code>).</p>\n\n",
        "linenr": 202,
        "html_filename": "Component2.html"
      },
      {
      ...
      },
      {
        ...
        "name": "toggleHandler",
        "owner": "Ext.button.Button",
        "doc": "<p>Function called when a Button with <a href=\"#/api/Ext.button.Button-cfg-enableToggle\" rel=\"Ext.button.Button-cfg-enableToggle\" class=\"docClass\">enableToggle</a> set to true is clicked. Two arguments are passed:<ul class=\"mdetail-params\">\n<li><b>button</b> : Ext.button.Button<div class=\"sub-desc\">this Button object</div></li>\n<li><b>state</b> : Boolean<div class=\"sub-desc\">The next state of the Button, true means pressed.</div></li>\n</ul></p>\n",
        "linenr": 231,
        "html_filename": "Button.html"
      },
      {
        ...
        "name": "tooltip",
        "owner": "Ext.button.Button",
        "doc": "<p>The tooltip for the button - can be a string to be used as innerHTML (html tags are accepted) or QuickTips config object</p>\n",
        "linenr": 191,
        "html_filename": "Button.html"
      },
      {
    ...
    "method": [
      ...
      },
      {
        ...
        "filename": "/mnt/ebs/nightly/git/SDK/extjs/src/button/Button.js",
        "private": false,
        "shortDoc": "Hide this button's menu (if it has one) ...",
        "static": false,
        "name": "hideMenu",
        "owner": "Ext.button.Button",
        "doc": "<p>Hide this button's menu (if it has one)</p>\n",
        "linenr": 953,
        "html_filename": "Button.html"
      },
      {
        ...
        "params": [
          {
            "type": "Number",
            "optional": false,
            "doc": "<p>The new height to set. This may be one of:<div class=\"mdetail-params\"><ul>\n<li>A Number specifying the new height in the <a href=\"#/api/Ext.button.Button-method-getEl\" rel=\"Ext.button.Button-method-getEl\" class=\"docClass\">Element</a>'s <a href=\"#/api/Ext.core.Element-property-defaultUnit\" rel=\"Ext.core.Element-property-defaultUnit\" class=\"docClass\">Ext.core.Element.defaultUnit</a>s (by default, pixels).</li>\n<li>A String used to set the CSS height style.</li>\n<li><i>undefined</i> to leave the height unchanged.</li>\n</ul></div></p>\n",
            "name": "height"
          }
        ],
      ...
      },
      {
        ...
        "name": "setIcon",
        "owner": "Ext.button.Button",
        "doc": "<p>Sets the background image (inline style) of the button.  This method also changes\nthe value of the <a href=\"#/api/Ext.button.Button-cfg-icon\" rel=\"Ext.button.Button-cfg-icon\" class=\"docClass\">icon</a> config internally.</p>\n",
        "linenr": 887,
        "html_filename": "Button.html"
      },
      {
        ...
        "name": "setIconCls",
        "owner": "Ext.button.Button",
        "doc": "<p>Sets the CSS class that provides a background image to use as the button's icon.  This method also changes\nthe value of the <a href=\"#/api/Ext.button.Button-cfg-iconCls\" rel=\"Ext.button.Button-cfg-iconCls\" class=\"docClass\">iconCls</a> config internally.</p>\n",
        "linenr": 761,
        "html_filename": "Button.html"
      },
      {
        ...
        "params": [
          {
            "type": "Mixed",
            "optional": false,
            "doc": "<p>The new width to set. This may be one of:<div class=\"mdetail-params\"><ul>\n<li>A Number specifying the new width in the <a href=\"#/api/Ext.button.Button-method-getEl\" rel=\"Ext.button.Button-method-getEl\" class=\"docClass\">Element</a>'s <a href=\"#/api/Ext.core.Element-property-defaultUnit\" rel=\"Ext.core.Element-property-defaultUnit\" class=\"docClass\">Ext.core.Element.defaultUnit</a>s (by default, pixels).</li>\n<li>A String used to set the CSS width style.</li>\n<li>A size object in the format <code>{width: widthValue, height: heightValue}</code>.</li>\n<li><code>undefined</code> to leave the width unchanged.</li>\n</ul></div></p>\n",
            "name": "width"
          },
          {
            "type": "Mixed",
      ...
      },
      {
        ...
        "filename": "/mnt/ebs/nightly/git/SDK/extjs/src/button/Button.js",
        "private": false,
        "shortDoc": "Show this button's menu (if it has one) ...",
        "static": false,
        "name": "showMenu",
        "owner": "Ext.button.Button",
        "doc": "<p>Show this button's menu (if it has one)</p>\n",
        "linenr": 935,
        "html_filename": "Button.html"
      },
      {
    ...
    "event": [
      ...
      },
      {
        ...
        "name": "beforedestroy",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires before the component is <a href=\"#/api/Ext.button.Button-event-destroy\" rel=\"Ext.button.Button-event-destroy\" class=\"docClass\">destroy</a>ed. Return false from an event handler to stop the <a href=\"#/api/Ext.button.Button-event-destroy\" rel=\"Ext.button.Button-event-destroy\" class=\"docClass\">destroy</a>.</p>\n",
        "linenr": 668,
        "html_filename": "AbstractComponent.html"
      },
      {
        ...
        "name": "beforehide",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires before the component is hidden when calling the <a href=\"#/api/Ext.button.Button-event-hide\" rel=\"Ext.button.Button-event-hide\" class=\"docClass\">hide</a> method.\nReturn false from an event handler to stop the hide.</p>\n",
        "linenr": 626,
        "html_filename": "AbstractComponent.html"
      },
      {
      ...
      },
      {
        ...
        "name": "beforeshow",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires before the component is shown when calling the <a href=\"#/api/Ext.button.Button-event-show\" rel=\"Ext.button.Button-event-show\" class=\"docClass\">show</a> method.\nReturn false from an event handler to stop the show.</p>\n",
        "linenr": 613,
        "html_filename": "AbstractComponent.html"
      },
      {
      ...
      },
      {
        ...
        "name": "destroy",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires after the component is <a href=\"#/api/Ext.button.Button-event-destroy\" rel=\"Ext.button.Button-event-destroy\" class=\"docClass\">destroy</a>ed.</p>\n",
        "linenr": 674,
        "html_filename": "AbstractComponent.html"
      },
      {
      ...
      },
      {
        ...
        "name": "hide",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires after the component is hidden.\nFires after the component is hidden when calling the <a href=\"#/api/Ext.button.Button-event-hide\" rel=\"Ext.button.Button-event-hide\" class=\"docClass\">hide</a> method.</p>\n",
        "linenr": 633,
        "html_filename": "AbstractComponent.html"
      },
      {
      ...
      },
      {
        ...
        "name": "show",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires after the component is shown when calling the <a href=\"#/api/Ext.button.Button-event-show\" rel=\"Ext.button.Button-event-show\" class=\"docClass\">show</a> method.</p>\n",
        "linenr": 620,
        "html_filename": "AbstractComponent.html"
      },
      {
    ...
    "property": [
      ...
      },
      {
        ...
        "name": "menu",
        "owner": "Ext.button.Button",
        "doc": "<p>The <a href=\"#/api/Ext.menu.Menu\" rel=\"Ext.menu.Menu\" class=\"docClass\">Menu</a> object associated with this Button when configured with the <a href=\"#/api/Ext.button.Button-property-menu\" rel=\"Ext.button.Button-property-menu\" class=\"docClass\">menu</a> config option.</p>\n",
        "linenr": 427,
        "html_filename": "Button.html"
      },
      {
  ...
  "doc": "<p>Create simple buttons with this component. Customisations include <a href=\"#/api/Ext.button.Button-cfg-iconAlign\" rel=\"Ext.button.Button-cfg-iconAlign\" class=\"docClass\">aligned</a>\n<a href=\"#/api/Ext.button.Button-cfg-iconCls\" rel=\"Ext.button.Button-cfg-iconCls\" class=\"docClass\">icons</a>, <a href=\"#/api/Ext.button.Button-property-menu\" rel=\"Ext.button.Button-property-menu\" class=\"docClass\">dropdown menus</a>, <a href=\"#/api/Ext.button.Button-cfg-tooltip\" rel=\"Ext.button.Button-cfg-tooltip\" class=\"docClass\">tooltips</a>\nand <a href=\"#/api/Ext.button.Button-cfg-scale\" rel=\"Ext.button.Button-cfg-scale\" class=\"docClass\">sizing options</a>. Specify a <a href=\"#/api/Ext.button.Button-cfg-handler\" rel=\"Ext.button.Button-cfg-handler\" class=\"docClass\">handler</a> to run code when\na user clicks the button, or use <a href=\"#/api/Ext.button.Button-cfg-listeners\" rel=\"Ext.button.Button-cfg-listeners\" class=\"docClass\">listeners</a> for other events such as\n<a href=\"#/api/Ext.button.Button-event-mouseover\" rel=\"Ext.button.Button-event-mouseover\" class=\"docClass\">mouseover</a>.</p>\n\n<p><p><img src=\"doc-resources/Ext.button.Button/Ext.button.Button1.png\" alt=\"Ext.button.Button component\"></p>\nExample usage:</p>\n\n<pre><code>Ext.create('Ext.Button', {\n    text: 'Click me',\n    renderTo: Ext.getBody(),        \n    handler: function() {\n        alert('You clicked the button!')\n    }\n});\n</code></pre>\n\n<p>The <a href=\"#/api/Ext.button.Button-cfg-handler\" rel=\"Ext.button.Button-cfg-handler\" class=\"docClass\">handler</a> configuration can also be updated dynamically using the <a href=\"#/api/Ext.button.Button-method-setHandler\" rel=\"Ext.button.Button-method-setHandler\" class=\"docClass\">setHandler</a> method.\nExample usage:</p>\n\n<pre><code>Ext.create('Ext.Button', {\n    text    : 'Dyanmic Handler Button',\n    renderTo: Ext.getBody(),\n    handler : function() {\n        //this button will spit out a different number every time you click it.\n        //so firstly we must check if that number is already set:\n        if (this.clickCount) {\n            //looks like the property is already set, so lets just add 1 to that number and alert the user\n            this.clickCount++;\n            alert('You have clicked the button \"' + this.clickCount + '\" times.\\n\\nTry clicking it again..');\n        } else {\n            //if the clickCount property is not set, we will set it and alert the user\n            this.clickCount = 1;\n            alert('You just clicked the button for the first time!\\n\\nTry pressing it again..');\n        }\n    }\n});\n</code></pre>\n\n<p>A button within a container:</p>\n\n<pre><code>Ext.create('Ext.Container', {\n    renderTo: Ext.getBody(),\n    items   : [\n        {\n            xtype: 'button',\n            text : 'My Button'\n        }\n    ]\n});\n</code></pre>\n\n<p>A useful option of Button is the <a href=\"#/api/Ext.button.Button-cfg-scale\" rel=\"Ext.button.Button-cfg-scale\" class=\"docClass\">scale</a> configuration. This configuration has three different options:\n<code>'small'</code>\n<code>'medium'</code>\n<code>'large'</code></p>\n\n<p><p><img src=\"doc-resources/Ext.button.Button/Ext.button.Button2.png\" alt=\"Ext.button.Button component\"></p>\nExample usage:</p>\n\n<pre><code>Ext.create('Ext.Button', {\n    renderTo: document.body,\n    text    : 'Click me',\n    scale   : 'large'\n});\n</code></pre>\n\n<p>Buttons can also be toggled. To enable this, you simple set the <a href=\"#/api/Ext.button.Button-cfg-enableToggle\" rel=\"Ext.button.Button-cfg-enableToggle\" class=\"docClass\">enableToggle</a> property to <code>true</code>.\n<p><img src=\"doc-resources/Ext.button.Button/Ext.button.Button3.png\" alt=\"Ext.button.Button component\"></p>\nExample usage:</p>\n\n<pre><code>Ext.create('Ext.Button', {\n    renderTo: Ext.getBody(),\n    text: 'Click Me',\n    enableToggle: true\n});\n</code></pre>\n\n<p>You can assign a menu to a button by using the <a href=\"#/api/Ext.button.Button-property-menu\" rel=\"Ext.button.Button-property-menu\" class=\"docClass\">menu</a> configuration. This standard configuration can either be a reference to a <a href=\"#/api/Ext.menu.Menu\" rel=\"Ext.menu.Menu\" class=\"docClass\">menu</a>\nobject, a <a href=\"#/api/Ext.menu.Menu\" rel=\"Ext.menu.Menu\" class=\"docClass\">menu</a> id or a <a href=\"#/api/Ext.menu.Menu\" rel=\"Ext.menu.Menu\" class=\"docClass\">menu</a> config blob. When assigning a menu to a button, an arrow is automatically added to the button.\nYou can change the alignment of the arrow using the <a href=\"#/api/Ext.button.Button-cfg-arrowAlign\" rel=\"Ext.button.Button-cfg-arrowAlign\" class=\"docClass\">arrowAlign</a> configuration on button.\n<p><img src=\"doc-resources/Ext.button.Button/Ext.button.Button4.png\" alt=\"Ext.button.Button component\"></p>\nExample usage:</p>\n\n<pre><code>Ext.create('Ext.Button', {\n    text      : 'Menu button',\n    renderTo  : Ext.getBody(),        \n    arrowAlign: 'bottom',\n    menu      : [\n        {text: 'Item 1'},\n        {text: 'Item 2'},\n        {text: 'Item 3'},\n        {text: 'Item 4'}\n    ]\n});\n</code></pre>\n\n<p>Using listeners, you can easily listen to events fired by any component, using the <a href=\"#/api/Ext.button.Button-cfg-listeners\" rel=\"Ext.button.Button-cfg-listeners\" class=\"docClass\">listeners</a> configuration or using the <a href=\"#/api/Ext.button.Button-method-addListener\" rel=\"Ext.button.Button-method-addListener\" class=\"docClass\">addListener</a> method.\nButton has a variety of different listeners:\n<code>click</code>\n<code>toggle</code>\n<code>mouseover</code>\n<code>mouseout</code>\n<code>mouseshow</code>\n<code>menuhide</code>\n<code>menutriggerover</code>\n<code>menutriggerout</code></p>\n\n<p>Example usage:</p>\n\n<pre><code>Ext.create('Ext.Button', {\n    text     : 'Button',\n    renderTo : Ext.getBody(),\n    listeners: {\n        click: function() {\n            //this == the button, as we are in the local scope\n            this.setText('I was clicked!');\n        },\n        mouseover: function() {\n            //set a new config which says we moused over, if not already set\n            if (!this.mousedOver) {\n                this.mousedOver = true;\n                alert('You moused over a button!\\n\\nI wont do this again.');\n            }\n        }\n    }\n});\n</code></pre>\n",

  ...
  "members": {
    "cfg": [
      ...
      },
      {
        ...
        "doc": "<p>Specifies whether the floated component should be automatically <a href=\"#/api/Ext.container.ButtonGroup-method-focus\" rel=\"Ext.container.ButtonGroup-method-focus\" class=\"docClass\">focused</a> when it is\n<a href=\"#/api/Ext.container.ButtonGroup-method-toFront\" rel=\"Ext.container.ButtonGroup-method-toFront\" class=\"docClass\">brought to the front</a>. Defaults to true.</p>\n",
        "linenr": 9,
    ...
    "property": [
      {
        ...
        "name": "dd",
        "owner": "Ext.panel.Panel",
        "doc": "<p>If this Panel is configured <a href=\"#/api/Ext.container.ButtonGroup-property-draggable\" rel=\"Ext.container.ButtonGroup-property-draggable\" class=\"docClass\">draggable</a>, this property will contain\nan instance of <a href=\"#/api/Ext.dd.DragSource\" rel=\"Ext.dd.DragSource\" class=\"docClass\">Ext.dd.DragSource</a> which handles dragging the Panel.</p>\n\n\n<p>The developer must provide implementations of the abstract methods of <a href=\"#/api/Ext.dd.DragSource\" rel=\"Ext.dd.DragSource\" class=\"docClass\">Ext.dd.DragSource</a>\nin order to supply behaviour for each stage of the drag/drop process. See <a href=\"#/api/Ext.container.ButtonGroup-property-draggable\" rel=\"Ext.container.ButtonGroup-property-draggable\" class=\"docClass\">draggable</a>.</p>\n",
        "linenr": 1393,
        "html_filename": "Panel2.html"
      },
      {

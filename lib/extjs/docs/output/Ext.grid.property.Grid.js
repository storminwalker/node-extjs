  ...
  "members": {
    "cfg": [
      ...
      },
      {
        ...
        "tagname": "cfg",
        "alias": null,
        "filename": "/mnt/ebs/nightly/git/SDK/extjs/src/grid/property/Grid.js",
        "private": false,
    ...
    "method": [
      ...
      },
      {
        ...
        "name": "collapse",
        "owner": "Ext.panel.Panel",
        "doc": "<p>Collapses the panel body so that the body becomes hidden. Docked Components parallel to the\nborder towards which the collapse takes place will remain visible.  Fires the <a href=\"#/api/Ext.grid.property.Grid-event-beforecollapse\" rel=\"Ext.grid.property.Grid-event-beforecollapse\" class=\"docClass\">beforecollapse</a> event which will\ncancel the collapse action if it returns false.</p>\n",
        "linenr": 891,
        "html_filename": "Panel2.html"
      },
      {
      ...
      },
      {
        ...
        "name": "expand",
        "owner": "Ext.panel.Panel",
        "doc": "<p>Expands the panel body so that it becomes visible.  Fires the <a href=\"#/api/Ext.grid.property.Grid-event-beforeexpand\" rel=\"Ext.grid.property.Grid-event-beforeexpand\" class=\"docClass\">beforeexpand</a> event which will\ncancel the expand action if it returns false.</p>\n",
        "linenr": 1182,
        "html_filename": "Panel2.html"
      },
      {
      ...
      },
      {
        ...
        "name": "toggleCollapse",
        "owner": "Ext.panel.Panel",
        "doc": "<p>Shortcut for performing an <a href=\"#/api/Ext.grid.property.Grid-event-expand\" rel=\"Ext.grid.property.Grid-event-expand\" class=\"docClass\">expand</a> or <a href=\"#/api/Ext.grid.property.Grid-event-collapse\" rel=\"Ext.grid.property.Grid-event-collapse\" class=\"docClass\">collapse</a> based on the current state of the panel.</p>\n",
        "linenr": 1370,
        "html_filename": "Panel2.html"
      },
      {
    ...
    "event": [
      ...
      },
      {
        ...
        "name": "beforedestroy",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires before the component is <a href=\"#/api/Ext.grid.property.Grid-event-destroy\" rel=\"Ext.grid.property.Grid-event-destroy\" class=\"docClass\">destroy</a>ed. Return false from an event handler to stop the <a href=\"#/api/Ext.grid.property.Grid-event-destroy\" rel=\"Ext.grid.property.Grid-event-destroy\" class=\"docClass\">destroy</a>.</p>\n",
        "linenr": 668,
        "html_filename": "AbstractComponent.html"
      },
      {
      ...
      },
      {
        ...
        "name": "beforehide",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires before the component is hidden when calling the <a href=\"#/api/Ext.grid.property.Grid-event-hide\" rel=\"Ext.grid.property.Grid-event-hide\" class=\"docClass\">hide</a> method.\nReturn false from an event handler to stop the hide.</p>\n",
        "linenr": 626,
        "html_filename": "AbstractComponent.html"
      },
      {
      ...
      },
      {
        ...
        "name": "beforeshow",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires before the component is shown when calling the <a href=\"#/api/Ext.grid.property.Grid-event-show\" rel=\"Ext.grid.property.Grid-event-show\" class=\"docClass\">show</a> method.\nReturn false from an event handler to stop the show.</p>\n",
        "linenr": 613,
        "html_filename": "AbstractComponent.html"
      },
      {
      ...
      },
      {
        ...
        "name": "destroy",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires after the component is <a href=\"#/api/Ext.grid.property.Grid-event-destroy\" rel=\"Ext.grid.property.Grid-event-destroy\" class=\"docClass\">destroy</a>ed.</p>\n",
        "linenr": 674,
        "html_filename": "AbstractComponent.html"
      },
      {
      ...
      },
      {
        ...
        "name": "show",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires after the component is shown when calling the <a href=\"#/api/Ext.grid.property.Grid-event-show\" rel=\"Ext.grid.property.Grid-event-show\" class=\"docClass\">show</a> method.</p>\n",
        "linenr": 620,
        "html_filename": "AbstractComponent.html"
      },
      {

  ...
  "members": {
    "cfg": [
      ...
      },
      {
        ...
        "doc": "<p>Specifies whether the floated component should be automatically <a href=\"#/api/Ext.slider.Multi-event-focus\" rel=\"Ext.slider.Multi-event-focus\" class=\"docClass\">focused</a> when it is\n<a href=\"#/api/Ext.slider.Multi-method-toFront\" rel=\"Ext.slider.Multi-method-toFront\" class=\"docClass\">brought to the front</a>. Defaults to true.</p>\n",
        "linenr": 9,
      ...
      },
      {
        ...
        "name": "toFrontOnShow",
        "owner": "Ext.Component",
        "doc": "<p>True to automatically call <a href=\"#/api/Ext.slider.Multi-method-toFront\" rel=\"Ext.slider.Multi-method-toFront\" class=\"docClass\">toFront</a> when the <a href=\"#/api/Ext.slider.Multi-event-show\" rel=\"Ext.slider.Multi-event-show\" class=\"docClass\">show</a> method is called\non an already visible, floating component (default is <code>true</code>).</p>\n\n",
        "linenr": 202,
        "html_filename": "Component2.html"
      },
      {
    ...
    "method": [
      ...
      },
      {
        ...
        "name": "checkDirty",
        "owner": "Ext.form.field.Field",
        "doc": "<p>Checks the <a href=\"#/api/Ext.slider.Multi-method-isDirty\" rel=\"Ext.slider.Multi-method-isDirty\" class=\"docClass\">isDirty</a> state of the field and if it has changed since the last time\nit was checked, fires the <a href=\"#/api/Ext.slider.Multi-event-dirtychange\" rel=\"Ext.slider.Multi-event-dirtychange\" class=\"docClass\">dirtychange</a> event.</p>\n",
        "linenr": 286,
        "html_filename": "Field.html"
      },
      {
      ...
      },
      {
        ...
        "owner": "Ext.form.field.Field",
        "doc": "<p>Only relevant if the instance's <a href=\"#/api/Ext.slider.Multi-method-isFileUpload\" rel=\"Ext.slider.Multi-method-isFileUpload\" class=\"docClass\">isFileUpload</a> method returns true. Returns a reference\nto the file input DOM element holding the user's selected file. The input will be appended into\nthe submission form and will not be returned, so this method should also create a replacement.</p>\n",
        "linenr": 373,
        "html_filename": "Field.html"
      },
      {
      ...
      },
      {
        ...
        "name": "getInputId",
        "owner": "Ext.form.field.Base",
        "doc": "<p>Returns the input id for this field. If none was specified via the <a href=\"#/api/Ext.slider.Multi-cfg-inputId\" rel=\"Ext.slider.Multi-cfg-inputId\" class=\"docClass\">inputId</a> config,\nthen an id will be automatically generated.</p>\n",
        "linenr": 294,
        "html_filename": "Base.html"
      },
      {
      ...
      },
      {
        ...
        "return": {
          "type": "Number/Array",
          "doc": "<p>The current value of the slider at the given index, or an array of\nall thumb values if no index is given.</p>\n"
        },
        "protected": false,
        "tagname": "method",
        "alias": null,
      ...
      },
      {
        ...
        "name": "isEqual",
        "owner": "Ext.form.field.Field",
        "doc": "<p>Returns whether two field <a href=\"#/api/Ext.slider.Multi-method-getValue\" rel=\"Ext.slider.Multi-method-getValue\" class=\"docClass\">values</a> are logically equal. Field implementations may override\nthis to provide custom comparison logic appropriate for the particular field's data type.</p>\n",
        "linenr": 158,
        "html_filename": "Field.html"
      },
      {
    ...
    "event": [
      ...
      },
      {
        ...
        "name": "beforedestroy",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires before the component is <a href=\"#/api/Ext.slider.Multi-event-destroy\" rel=\"Ext.slider.Multi-event-destroy\" class=\"docClass\">destroy</a>ed. Return false from an event handler to stop the <a href=\"#/api/Ext.slider.Multi-event-destroy\" rel=\"Ext.slider.Multi-event-destroy\" class=\"docClass\">destroy</a>.</p>\n",
        "linenr": 668,
        "html_filename": "AbstractComponent.html"
      },
      {
        ...
        "name": "beforehide",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires before the component is hidden when calling the <a href=\"#/api/Ext.slider.Multi-event-hide\" rel=\"Ext.slider.Multi-event-hide\" class=\"docClass\">hide</a> method.\nReturn false from an event handler to stop the hide.</p>\n",
        "linenr": 626,
        "html_filename": "AbstractComponent.html"
      },
      {
      ...
      },
      {
        ...
        "name": "beforeshow",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires before the component is shown when calling the <a href=\"#/api/Ext.slider.Multi-event-show\" rel=\"Ext.slider.Multi-event-show\" class=\"docClass\">show</a> method.\nReturn false from an event handler to stop the show.</p>\n",
        "linenr": 613,
        "html_filename": "AbstractComponent.html"
      },
      {
      ...
      },
      {
        ...
        "name": "destroy",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires after the component is <a href=\"#/api/Ext.slider.Multi-event-destroy\" rel=\"Ext.slider.Multi-event-destroy\" class=\"docClass\">destroy</a>ed.</p>\n",
        "linenr": 674,
        "html_filename": "AbstractComponent.html"
      },
      {
      ...
      },
      {
        ...
        "name": "show",
        "owner": "Ext.AbstractComponent",
        "doc": "<p>Fires after the component is shown when calling the <a href=\"#/api/Ext.slider.Multi-event-show\" rel=\"Ext.slider.Multi-event-show\" class=\"docClass\">show</a> method.</p>\n",
        "linenr": 620,
        "html_filename": "AbstractComponent.html"
      },
      {
